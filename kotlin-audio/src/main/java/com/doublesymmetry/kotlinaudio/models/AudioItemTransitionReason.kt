...
sealed class AudioItemTransitionReason(val oldPosition: Long) {
     ...
     * [QueuedAudioPlayer.next][com.heistdotcom.kotlinaudio.players.QueuedAudioPlayer.next]
     * or [QueuedAudioPlayer.previous][com.heistdotcom.kotlinaudio.players.QueuedAudioPlayer.previous].
     */
